...
{{ cookiecutter.projectName }} was written by {{ cookiecutter.authorString }}
...
1. Is your code legal (It must be GPL V.2 since NVDA is GPL V.2. and your add-on is a part of NVDA during execution. There are a few exceptions, see the NVDA users guide for more info). Also, add-ons that pirate speech synthesisers, or do other illegal things will not be accepted.
